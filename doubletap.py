...
def tcpEnum(ip_address):
    ...
    TCPALL = "nmap -sV -Pn -p1-65535 --max-retires 1 --max-scan-delay 10 --defeat-rst-ratelimit --open -T5 %s | tee %s%s/port_scans/fulltcp_%s.nmap" % (ip_address, dirs, ip_address, ip_address)
